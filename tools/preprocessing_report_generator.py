...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>TI-Toolbox Preprocessing Report - {self.bids_subject_id}</title>
    <style>
...
<body>
    <div class="container">
        <header>
            <h1>TI-Toolbox Preprocessing Report</h1>
        ...
        <footer>
                    <p>Report generated by TI-Toolbox 2.0 Preprocessing Pipeline</p>
...
"""
    ...
    def _generate_methods_section(self):
        ...
        Results included in this manuscript come from preprocessing performed using TI-Toolbox 2.0 
