 ...
 *
 * V1 (`docs/dev/DECISIONS.md § 2026-09-06 (Native panes, job rows and notebooks)`) removed the embed, and with it the
...
// -------------------------------------------------------------------------------------------------
// R5 — the draft/loaded model's pure half (docs/dev/DECISIONS.md § 2026-09-05 (Overview, batch execution and explicit viewing)).
//
