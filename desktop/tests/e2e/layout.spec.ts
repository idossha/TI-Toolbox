...
/**
 * The layout pass's acceptance, as numbers (plan `docs/dev/DECISIONS.md § 2026-09-04 (Scene service and retained pages)` §4, L1–L5).
 *
...
test.beforeAll(async () => {
  // V4 (docs/dev/DECISIONS.md § 2026-09-06 (Native panes, job rows and notebooks)): the embed and its protocol range are
