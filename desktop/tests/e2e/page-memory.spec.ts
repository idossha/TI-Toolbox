 ...
 *
 * The model this spec encodes (`docs/dev/DECISIONS.md § 2026-09-04 (Scene service and retained pages)` §1):
 *
...
test.beforeAll(async () => {
  // V4 (docs/dev/DECISIONS.md § 2026-09-06 (Native panes, job rows and notebooks)): the embed, its protocol range and the
