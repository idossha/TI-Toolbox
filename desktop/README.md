...
Plan of record: `../dev/notes/v3-build-plan.md`, design contract: `DESIGN.md`, API contract:
...
npm run gen:api             # contracts/openapi.v0.yaml -> src/renderer/api/schema.d.ts
npm run typecheck
npm run lint
npm test                    # vitest
