...
class ContactTab(QtWidgets.QWidget):
    ...
    def create_github_section(self):
        ...
        discuss_description = QtWidgets.QLabel(
            "Have questions, ideas for improvements, or want to connect with other users? Visit our GitHub Discussions page to share your thoughts and join the community conversation. This is the best place to propose and discuss new features!"
        )
        ...
        bug_description = QtWidgets.QLabel(
            "Found a problem? Let us know so we can fix it. Visit the GitHub issues page to report bugs."
        )
        ...
        pr_description = QtWidgets.QLabel(
            "Already implemented a fix or feature? Submit a pull request through GitHub to contribute your code."
        )
