...
class NotesWindow(QtWidgets.QDialog):
    ...
    def add_note(self):
        ...
        if not note_text:
            QtWidgets.QMessageBox.warning(
                self, "Empty Note", "Please enter some text before adding a note."
            )
            return
    ...
    def clear_all_notes(self):
        ...
        if not self.notes:
            QtWidgets.QMessageBox.information(
                self, "No Notes", "There are no notes to clear."
            )
            return
    ...
    def copy_to_clipboard(self):
        ...
        if not self.notes:
            QtWidgets.QMessageBox.information(
                self, "No Notes", "There are no notes to copy."
            )
            return
        ...
        QtWidgets.QMessageBox.information(
            self, "Copied", "All notes have been copied to the clipboard."
        )
