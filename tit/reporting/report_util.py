...
def _get_report_filename(
    report_type: str, subject_id: str, timestamp: str = None
) -> str:
    """
...
def create_preprocessing_report(
    ...
    clean_subject_id = (
        subject_id.replace("sub-", "") if subject_id.startswith("sub-") else subject_id
    )
...
def get_preprocessing_report_generator(
...
def get_simulation_report_generator(
    project_dir: str, simulation_session_id: Optional[str] = None
...
def list_reports(
    ...
    if subject_id:
        ...
        subject_dirs = (
            [reports_base / subject_id] if (reports_base / subject_id).exists() else []
        )
    else:
        subject_dirs = [
            d
...
def get_latest_report(
    project_dir: str, subject_id: str, report_type: str
) -> Optional[str]:
    """
