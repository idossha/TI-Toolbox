...
Plan of record: `dev/notes/v3-tetravox-selection-pipeline-plan.md` (A–D, lanes, gates). Read it fully first, then
...
- Deliverable: your lane note `dev/notes/v3-tetravox-selection-pipeline/<LANE>.md` with: what changed (file list),
