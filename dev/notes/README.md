...
| `v3-native-panes-external-viewer-plan.md`, `v3-native-panes-external-viewer/*` (`NR.md`, `VE.md`, `VM.md`, `VM2.md`, `VX.md`, `IB.md`, `JB.md`, `NB.md`, `OJ.md`, `PL.md`, `TI.md`, `TR.md`, `CX3.md`, `CX4.md`, `CX5.md`) | § 2026-09-06 — Native panes, external viewer; `docs/requirements/2026-09-06-native-panes-external-viewer.md`; gate detail in `docs/ROADMAP.md` |
