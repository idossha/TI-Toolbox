...
Usage:
    ...
    simnibs_python ti-toolbox/benchmark/charm.py
    simnibs_python ti-toolbox/benchmark/recon.py
    simnibs_python ti-toolbox/benchmark/dicom.py
    simnibs_python ti-toolbox/benchmark/flex.py
    
    # Or use Python API
    from ti_toolbox.benchmark import BenchmarkTimer, print_hardware_info
"""
