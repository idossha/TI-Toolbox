...
Usage:
  ...
  python -m benchmark.flex --m2m-dir /path/to/m2m_101 --multistart 1,2,3
"""
...
def run_flex_optimization(subject_id, project_dir, n_multistart, logger, **params):
    ...
    try:
        ...
        # Add ti-toolbox to PYTHONPATH
        ti_toolbox_path = "/development/ti-toolbox" if os.path.exists("/development") else \
