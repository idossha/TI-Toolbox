...
sys.path.insert(0, str(ti_toolbox_path / "tools"))
from logging_util import get_logger

# Import tool functions
from extract_labels import extract_labels_from_nifti
from nifti_to_mesh import nifti_to_mesh

# Import 3D exporter modules
sys.path.insert(0, str(ti_toolbox_path / "3d_exporter"))
from electrode_placement import ElectrodePlacer, ElectrodePlacementConfig
...
class VisualExporterWidget(QtWidgets.QWidget):
    ...
    def _place_electrodes(self, subject_id: str, net_name: str, 
        ...
        electrode_blend_path = os.path.join(ti_toolbox_path, "3d_exporter", "Electrode.blend")
