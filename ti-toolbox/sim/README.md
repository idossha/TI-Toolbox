...
```python
from ti_toolbox.sim import run_simulation, SimulationConfig, ParallelConfig
...
```python
from ti_toolbox.sim import run_simulation, SimulationConfig, ElectrodeConfig, IntensityConfig, ConductivityType
from ti_toolbox.sim.montage_loader import load_montages
...
- SimNIBS 4.5+
- NumPy
- ti-toolbox core modules (PathManager, logging_util, calc)
