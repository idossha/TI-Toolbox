...
> Historical v2 release notes, retained for legacy users. These describe the interface and
> behavior of this version. See the [current release overview]({{ site.baseurl }}/releases/)
> for v3 availability and migration guidance.
...
[Windows](https://github.com/idossha/TI-Toolbox/releases/download/v2.4.0/TI-Toolbox.Setup.2.4.0.exe) ·
[Linux AppImage](https://github.com/idossha/TI-Toolbox/releases/download/v2.4.0/TI-Toolbox-2.4.0.AppImage) ·
[Linux deb](https://github.com/idossha/TI-Toolbox/releases/download/v2.4.0/ti-toolbox_2.4.0_amd64.deb)
