...
<div class="gallery-section">
  ...
  <div class="gallery-grid">
    <div class="gallery-item">
      <img src="{{ site.baseurl }}/gallery/assets/flex-search/flex-search.png" alt="Flex-Search Optimization" onclick="openLightbox(this)" />
      <p>Evolutionary optimization showing flexible electrode placement unbound by EEG net.</p>
    </div>
    <div class="gallery-item">
      <img src="{{ site.baseurl }}/gallery/assets/flex-search/mapping.png" alt="Electrode Mapping" onclick="openLightbox(this)" />
