---
layout: gallery
title: V2 Gallery (Deprecated)
permalink: /gallery/v2/
---

# V2 gallery (deprecated)

These screenshots document the v2 interface for legacy users. The PyQt5 GUI was removed in v3.0.0.
For the current interface, see the [v3 desktop gallery]({{ site.baseurl }}/gallery/UI/).
The [Gmsh & Freeview gallery]({{ site.baseurl }}/gallery/gmsh-freeview/) preserves the classic external-viewer workflow.
Legacy developers can use the [v2 development archive]({{ site.baseurl }}/wiki/v2-development/).

<link rel="stylesheet" href="{{ '/assets/css/lightbox.css' | relative_url }}">

<div class="gallery-section">
  <h3>PyQt interface — v2 (deprecated)</h3>
  <p>These are the tabs of the PyQt5 GUI, removed in v3.0.0 and retained for users working with v2.</p>
