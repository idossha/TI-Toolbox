...
A full-net montage can need **about 16 GiB of available container memory**. Increase Docker
Desktop's memory allocation accordingly and leave headroom for other running workloads.
The scheduler reserves 16 GiB for montage jobs; this is a conservative reservation and
headroom recommendation, **not an uncapped measured peak**. Vector, region and subcortical
  ...
  <div class="carousel-wrapper">
    <div class="carousel-images">
      <div class="carousel-slide active">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_stl_sample.png" alt="STL Export Sample">
        <p>STL format export showing cortical surface geometry</p>
      </div>
      <div class="carousel-slide">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_ply_sample.png" alt="PLY Export Sample">
        <p>PLY format export with color-mapped field data</p>
      </div>
      <div class="carousel-slide">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_ply_sample_2.png" alt="PLY Export Sample 2">
...
<div class="carousel-container">
  <div class="carousel-wrapper">
    <div class="carousel-images">
      <div class="carousel-slide active">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_vectors.png" alt="Vector Field Visualization">
        <p>TI vector field visualization showing electric field directions and magnitudes</p>
      </div>
      <div class="carousel-slide">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_vectors_close.png" alt="Close-up Vector Field Visualization">
        <p>Close-up view of the vector field, highlighting individual arrow placement and detail</p>
      </div>
      <div class="carousel-slide">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_rgb_vectors.png" alt="RGB Vector Visualization">
...
<div class="carousel-container">
  <div class="carousel-wrapper">
    <div class="carousel-images">
      <div class="carousel-slide active">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_electrodes_subcortical.png" alt="Electrode Placement with Sub-cortical Structures">
...
<div class="glb-viewer-section">
  ...
  <div class="glb-viewer">
    <model-viewer
      src="{{ site.baseurl }}/assets/imgs/blender/electrodes_GSN-HydroCel-185.glb"
...
![Import PLY file]({{ site.baseurl }}/assets/imgs/blender/visual_exporter_blender_1.png)
...
![Material Preview mode]({{ site.baseurl }}/assets/imgs/blender/visual_exporter_blender_2.png)
...
![Adding a material]({{ site.baseurl }}/assets/imgs/blender/visual_exporter_blender_3.png)
...
<div class="carousel-container">
  <div class="carousel-wrapper">
    <div class="carousel-images">
      <div class="carousel-slide active">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_blender_4.png" alt="Setting color attribute - Attribute node">
        <p>Adding the Attribute node and setting it to 'col'</p>
      </div>
      <div class="carousel-slide">
        <img src="{{ site.baseurl }}/assets/imgs/blender/visual_exporter_blender_5.png" alt="Setting color attribute - Connected shader">
