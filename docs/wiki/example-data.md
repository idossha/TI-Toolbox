...
- **First time you open a new project** the app asks *Add example data?* and lists the parts under
...
- **Help ▸ Example data** has the same grouping at any time, with a **Download** button per part,
  a slim progress bar while one runs, and *Installed ✓* (plus a quiet re-download) for what this
