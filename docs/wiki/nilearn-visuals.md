...
1. **Open tool**: enable **Nilearn visuals** in **Settings → Extensions**, then select it under **Extensions** in the sidebar
...
<div class="image-container">
  <img src="{{ site.baseurl }}/assets/imgs/nilearn-visuals/nilearn_visuals_glass_brain.png" alt="Glass Brain View" style="max-width: 50%; height: auto;">
  <em>Glass brain projection showing TI field distribution with transparency for 3D visualization</em>
</div>

<div class="image-container">
  <img src="{{ site.baseurl }}/assets/imgs/nilearn-visuals/nilearn_visuals_sliced_brain.png" alt="Sliced Brain View" style="max-width: 50%; height: auto;">
