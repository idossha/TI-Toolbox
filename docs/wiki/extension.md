...
Computational optional tools are **panels** you switch on per project in **Settings &#9656; Optional tools**.
...
> (`desktop/src/renderer/pages/panel-*/`), each backed by a `tit` job runner.
