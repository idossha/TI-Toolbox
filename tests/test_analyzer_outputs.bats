...
@test "Analyzer outputs exist under Analyses after analyzer_runner" {
    ...
    SIMULATION_NAME="central_montage"
    ...
    # Spherical outputs (decimal format with 2 decimal places)
    spherical_dir="$analyses_mesh/sphere_x-50.00_y0.00_z0.00_r5.0_subject"
    [ -d "$spherical_dir" ]
