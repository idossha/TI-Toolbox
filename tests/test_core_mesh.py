...
class TestCreateMeshOptFile:
    ...
    def test_opt_file_without_max_values(self, tmp_path):
        ...
        field_info = {"fields": ["normE", "normJ"], "field_type": "node"}
    ...
    def test_opt_file_colormap_settings(self, tmp_path):
        ...
        field_info = {"fields": ["normE"], "max_values": {"normE": 1.0}}
    ...
    def test_opt_file_empty_field_list(self, tmp_path):
        ...
        field_info = {"fields": [], "max_values": {}, "field_type": "node"}
    ...
    def test_opt_file_overwrite_existing(self, tmp_path):
        ...
        opt_path_1 = create_mesh_opt_file(
            str(mesh_path.with_suffix("")),
            {"fields": ["normE"], "max_values": {"normE": 1.0}},
        )
        ...
        opt_path_2 = create_mesh_opt_file(
            str(mesh_path.with_suffix("")),
            {"fields": ["TImax"], "max_values": {"TImax": 2.0}},
        )
