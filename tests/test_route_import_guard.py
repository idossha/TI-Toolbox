...
What this pins
    ...
    down (``docs/dev/DECISIONS.md § 2026-09-04 (Scene service and retained pages)`` §6 F1).
...
Where the numbers come from
    ...
    ``simnibs`` at 3 197 ms (``docs/dev/DECISIONS.md § 2026-09-04 (Scene service and retained pages)`` §A4).
