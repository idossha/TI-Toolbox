...
`tit.examples.fetch_ernie(PROJECT)`, which downloads both parts of the `ernie` example dataset
(its raw T1/T2 and its finished `m2m_ernie` head model, GPL-3.0) into the project once.
