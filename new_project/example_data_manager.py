...
class ExampleDataManager:
    ...
    def __init__(self, toolbox_root: str, project_dir: str):
        ...
        self.example_data_dir = self.toolbox_root / "assets" / "example_data"
    ...
    def _create_data_mapping(self) -> Dict[str, Dict[str, str]]:
        ...
        mapping = {
            ...
            "MNI152": {
                "T1.nii.gz": "sub-MNI152/anat/sub-MNI152_T1w.nii.gz"
            }
        }
    ...
    def copy_example_data(self) -> Tuple[bool, List[str]]:
        ...
        for subject_key, file_mapping in self.data_mapping.items():
            ...
            if subject_copied:
                ...
                subject_id = list(file_mapping.values())[0].split('/')[0]  # Get subject ID from first mapping
                copied_subjects.append(subject_id)
        
        # Copy the readme file to the project root for reference
        ...
        if success:
            logger.info(f"Successfully copied example data for {len(copied_subjects)} subjects")
        else:
            logger.warning(f"Copied {successful_operations}/{total_operations} items successfully")
        ...
        try:
            dataset_desc = {
                ...
                "ReferencesAndLinks": [
                    ...
                    "https://github.com/guilhermecxe/TI-toolbox"
                ]
            }
...
if __name__ == "__main__":
    ...
    if success:
        print(f"✓ Successfully set up example data with subjects: {', '.join(subjects)}")
    else:
